  ...
  <div class="content-wrapper">
    ...
    <?php 
      if(isset($_POST['add'])){
        ...
        if($name!="" && $country!=""){
          $data=mysqli_query($connect,"insert thuonghieu values('','$name','$country','$file_name')");
        }
        else {
    ...
    <form action="brand.php" method="post" enctype="multipart/form-data">
      <div class="card-body">
        ...
        <input type="text" class="form-control" placeholder="Tên thương hiệu..." name="brandname"><br>
        <label for="">Quốc gia</label>
        <input type="text" class="form-control" placeholder="Quốc gia..." name="quocgia">
    ...
    <table class="table table-striped">
      <tr>
        ...
        <?php 
            $data=mysqli_query($connect,"select * from thuonghieu");
            while($row=mysqli_fetch_assoc($data)){
              ...
              echo '<td><a href="updatebrand.php?id='.$row['id'].'" class="btn btn-primary btn-sm"><i class="fas fa-pen"></i></a>&ensp;<a href="delbrand.php?id='.$row['id'].'" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></a></td>';
              echo '</tr>';
