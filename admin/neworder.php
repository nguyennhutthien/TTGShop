...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <?php 
          $data=mysqli_query($connect,"SELECT order.id,order.name,order.sdt,order.diachi,order.email,sanpham.name as tensp,order.sl,order.thanhtien,order.tinhtrang FROM `order`,sanpham WHERE order.masanpham=sanpham.id and order.xacnhan=b'0';");
          while($row=mysqli_fetch_assoc($data)){
              echo '<tr>';
                ...
                echo '<td><a href="submitproduct.php?id='.$row['id'].'" class="btn btn-success btn-sm"><i class="fas fa-check"></i></a></td>';
                echo '</tr>';
          }
    ?>
    </table>
