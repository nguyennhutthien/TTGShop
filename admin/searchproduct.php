  ...
  <div class="content-wrapper">
    ...
    <form action="searchproduct.php" method="post">
      <div class="input-group rounded">
        <input type="search" class="form-control rounded" placeholder="Tìm kiểm sản phẩm...." aria-label="Search" aria-describedby="search-addon" name="productname"/>
    ...
    <?php 
      if(isset($_POST['search'])){
            ...
            if(mysqli_num_rows($data)>0){
              ...
              echo "<span class='alert alert-danger'>Không tìm thấy sản phẩm '".$productname."'</span>";
            }
      }
    ?>
    </table>
